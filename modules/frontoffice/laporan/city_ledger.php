...
<div class="p-6">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow-lg p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-white mb-2">City Ledger</h1>
                <p class="text-blue-100">Manage City Ledger for hotel operations</p>
            </div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-semibold text-gray-800">City Ledger Management</h2>
...
console.log('City Ledger module loaded');
</script>
