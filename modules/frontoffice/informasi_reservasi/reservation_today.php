<?php
// modules/frontoffice/informasi_reservasi/reservation_today.php
...
$sql_data = "SELECT reservation_no, guest_name, market_segment, created_at AS booking, arrival_date, departure_date, transaction_by AS reserved_by, 'N/A' AS deposit_by, deposit, (guest_male + guest_female + guest_child) AS guest_count FROM hotel_reservations WHERE arrival_date = :today_date";
...
function get_sort_link($column, $display, $current_sort, $current_order) {
    ...
    return "<a href=\"?module=frontoffice/informasi_reservasi/reservation_today&sort=$column&order=$order\">$display $arrow</a>";
}
    ...
    <table class="data-table">
        ...
        <tbody>
            <?php if (empty($reservations)): ?>
                <tr>
                    <td colspan="10" style="text-align: center;">No reservations for today.</td>
                </tr>
            <?php else: ?>
