...
<div class="p-6">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow-lg p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-white mb-2">Master Package</h1>
                <p class="text-blue-100">Manage Master Package for hotel operations</p>
            </div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-semibold text-gray-800">Master Package Management</h2>
...
console.log('Master Package module loaded');
</script>
