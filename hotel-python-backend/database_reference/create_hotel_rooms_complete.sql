-- =============================================
-- Hotel Rooms Complete Database Creation
-- Updated with Hit column and all 134 rooms
-- September 22, 2025
-- =============================================
...
CREATE TABLE hotel_rooms (
    ...
    hit_count INT DEFAULT 0 COMMENT 'Number of times room has been used',
...
-- Create room availability view with Hit data
...
CREATE INDEX idx_room_hit_count ON hotel_rooms(hit_count DESC);
CREATE INDEX idx_room_floor_type ON hotel_rooms(floor_number, room_type);
CREATE INDEX idx_room_availability ON hotel_rooms(status, is_active);
...
-- Floor distribution with Hit statistics  
SELECT 
    floor_number,
    COUNT(*) as room_count,
    ROUND(AVG(hit_count), 2) as avg_hits,
