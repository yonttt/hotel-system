...
from app.tables import GroupBooking, GroupBookingRoom, HotelReservation, User
    ...
    try:
        ...
        for index, room in enumerate(booking.rooms):
            ...
            db_reservation = HotelReservation(
                ...
                nights=booking.nights,
                guest_type='Normal',
                guest_male=room.guest_count_male or 0,
                guest_female=room.guest_count_female or 0,
                guest_child=room.guest_count_child or 0,
                extra_bed_qty=room.extra_bed or 0,
                room_number=room.room_number,
                transaction_status='Confirmed',
                payment_method=booking.payment_method,
                note=f"Group: {booking.group_name}, PIC: {booking.group_pic}, Phone: {booking.pic_phone}. {booking.notes or ''}",
